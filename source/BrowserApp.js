enyo.kind({
    ...
    }, 
	{
        ...
        method: "download",
        onSuccess: "gotDownloadStatus",
        onFailure: "gotDownloadFailure",
        subscribe: true,
        resubscribe: true
    }, {
        name: "cancelDownloadService",
        kind: enyo.PalmService,
        service: "palm://com.palm.downloadmanager/",
        method: "cancelDownload"
    }, {
        name: "downloadHistoryService",
        kind: enyo.PalmService,
        service: "palm://com.palm.downloadmanager/",
        method: "getAllHistory",
        onSuccess: "gotDownloadHistory"
    }, {
        name: "clearDownloadsService",
        kind: enyo.PalmService,
        service: "palm://com.palm.downloadmanager/",
        method: "clearHistory"
    }, {
        name: "bookmarksService",
        kind: "DbService",
        dbKind: "com.palm.browserbookmarks:1",
        reCallWatches: true
    }, {
        name: "historyService",
        kind: "DbService",
        dbKind: "com.palm.browserhistory:1",
        reCallWatches: true
    }, {
        name: "systemPrefsService",
        kind: "SystemService"
    }, {
        name: "browserPrefsService",
        kind: "DbService",
        dbKind: "com.palm.browserpreferences:1",
        reCallWatches: true
    }, {
        name: "universalSearchService",
        kind: enyo.PalmService,
        service: "palm://com.palm.universalsearch/",
        method: "getUniversalSearchList",
        onSuccess: "gotUniversalSearchList",
        subscribe: true,
        resubscribe: true
    }, {
        name: "setSearchPreferenceService",
        kind: enyo.PalmService,
        service: "palm://com.palm.universalsearch/",
        method: "setSearchPreference"
    }, {
        name: "clearOptionalSearchListService",
        kind: enyo.PalmService,
        service: "palm://com.palm.universalsearch/",
        method: "clearOptionalSearchList"
    }, {
        name: "stService",
        kind: "PalmService",
        ...
        name: "resourceInfoService",
        kind: "PalmService",
        service: enyo.palmServices.application,
        method: "getResourceInfo",
        onSuccess: "gotResourceInfo",
        onFailure: "gotResourceError"
    }, {
        kind: enyo.Pane,
        flex: 1,
            ...
            components: [{
                ...
                components: [{
                    ...
                    components: [{
                        ...
                        icon: "images/chrome/toaster-icon-bookmarks.png",
                        onclick: "showBookmarks"
                    }, {
                        kind: "RadioButton",
                        value: "history",
                        className: "enyo-radiobutton-dark",
                        icon: "images/chrome/toaster-icon-history.png",
                        onclick: "showHistory"
                    }, {
                        kind: "RadioButton",
                        value: "downloads",
                        className: "enyo-radiobutton-dark",
                        icon: "images/chrome/toaster-icon-downloads.png",
        ...
        kind: "BookmarkDialog",
        onAccept: "bookmarkAccept",
        onBeforeOpen: "setupBookmarkDialog"
    }, {
        name: "downloadError",
        kind: "BrowserPrompt",
        caption: $L("Cannot open MIME type"),
        message: ""
    }, {
        name: "clearDownloadsDialog",
        kind: "BrowserPrompt",
        ...
        kind: "AppMenu",
        onBeforeOpen: "toggleAppMenuItems",
        components: [
    ...
    applicationRelaunchHandler: function (inSender) {
        ...
        if (params.sendDataToShare !== undefined) {
            this.$.stService.call({
                data: {
                    target: c.enyo.$.browserApp.getUrl(),
                    type: "rawdata",
                    mimetype: "text/html"
                }
            }, {
    ...
    gotInitialBrowserPreferences: function (inSender, inResponse) {
        ...
        if (inResponse.results.length == 0) {
            this.$.browserPrefsService.call({
                objects: defaultBrowserPreferences
            }, {
                method: "put",
    ...
    fetchInitialPreferences: function () {
        this.$.browserPrefsService.call(undefined, {
            method: "find",
            onSuccess: "gotInitialBrowserPreferences"
        });
    },
    fetchPreferences: function (inSuccessCallback, inSubscribe) {
        var systemPreferences = ["flashplugins", "click2play"];
        this.$.systemPrefsService.call({
            keys: systemPreferences
        }, {
            method: "getPreferences",
            onSuccess: "gotSystemPreferences",
            subscribe: true
        });
        this.$.browserPrefsService.call(undefined, {
            method: "find",
            onSuccess: "gotBrowserPreferences",
            subscribe: true
        });
    ...
    preferenceChanged: function (inSender, inPreference, inType, inValue) {
        if (inType === "System") {
            ...
            this.$.systemPrefsService.call(p, {
            ...
            this.$.browserPrefsService.call({
                ...
                query: {
                    from: this.$.browserPrefsService.dbKind,
                    where: [{
                        prop: "key",
                        "op": "=",
                        "val": inPreference
            ...
            this.$.setSearchPreferenceService.call({
    ...
    clearDownloads: function () {
        ...
        this.$.downloads.setDownloads(this.downloads);
        this.$.clearDownloadsService.call({
    ...
    gotDownloadStatus: function (inSender, inResponse) {
        ...
        if (d) {
            ...
            if (!this.$.downloads.showing && d.completed) {
                ...
                var params = enyo.json.stringify({
                    toasterOpen: "downloads"
                });
    ...
    refreshDownloads: function () {
        this.$.downloadHistoryService.call({
            owner: enyo.fetchAppId()
        });
    },
    ...
    clearHistory: function () {
        this.$.historyService.call(undefined, {
            method: "delByQuery"
        });
        if (this.$.browser) {
    ...
    addToLauncher: function (inTitle, inUrl, inIcons, inId) {
        this.$.addToLauncherService.call({
            id: enyo.fetchAppId(),
            icon: inIcons.iconFile64,
            title: inTitle,
            params: {
                url: inUrl
            }
    ...
    showEditBookmarkDialog: function (inSender, inBookmark) {
        ...
        this.$.bookmarkDialog.setIcons({
            thumbnailFile: inBookmark.thumbnailFile,
            iconFile32: inBookmark.iconFile32,
            iconFile64: inBookmark.iconFile64
        });
    ...
    clearBookmarks: function () {
        this.$.bookmarksService.call(undefined, {
            method: "delByQuery"
        });
    },
    ...
    helpClick: function () {
        this.$.launchApplicationService.call({
            params: {
                target: "http://help.palm.com/web/index.html"
            },
